...
import com.example.sky.Utils.GetTimeUtils;
...
public class DropListView extends ListView implements AbsListView.OnScrollListener {
    ...
    private void initView(Context context) {
        ...
        noData = (TextView) footer.findViewById(R.id.footer_noData);
        more = (TextView) footer.findViewById(R.id.footer_more);
        loading = (ProgressBar) footer.findViewById(R.id.footer_loading);

        header = inflater.inflate(R.layout.listview_header, null);
        arrow = (ImageView) header.findViewById(R.id.header_arrow);
        tip = (TextView) header.findViewById(R.id.header_tip);
        lastUpdate = (TextView) header.findViewById(R.id.header_lastUpdate);
        refreshing = (ProgressBar) header.findViewById(R.id.header_refreshing);
    ...
    public void onRefreshComplete(String updateTime) {
        lastUpdate.setText("最近更新："+GetTimeUtils.getCurrentTime());
        state = NONE;
